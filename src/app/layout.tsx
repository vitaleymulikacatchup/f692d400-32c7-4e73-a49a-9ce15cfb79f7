...
export const metadata: Metadata = {
  title: "BrewHaven - Specialty Coffee & Cozy Cafe",
  description: "Discover exceptional specialty coffee, fresh pastries, and a welcoming atmosphere at BrewHaven. Premium single-origin blends roasted daily.",
  keywords: "specialty coffee, espresso, cafe, artisan coffee, single-origin coffee",
  metadataBase: new URL("https://brewhaven.com"),
  alternates: {
    canonical: "https://brewhaven.com"
  },
  openGraph: {
    title: "BrewHaven - Where Coffee Meets Community",
    description: "Experience exceptional specialty coffee crafted with passion in our cozy cafe.",
    siteName: "BrewHaven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765878946195-5ukrvlo1.jpg",
  ...
  twitter: {
    ...
    description: "Specialty coffee roasted fresh daily. Visit us for the perfect brew.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765878946195-5ukrvlo1.jpg"]
  }
};
